...
assert isinstance(N_JOBS, int) and N_JOBS > 0, f''
...
DEFAULT_PIPELINE__MIMIC__CSV_TEST_FILE_PATH = os.path.join(DIBS_BASE_PROJECT_PATH, 'tests', 'test_data', DEFAULT_PIPELINE__MIMIC__CSV_TEST_FILE)
